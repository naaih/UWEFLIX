...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::factory(1)->create([
            ...
            'email' => 'systemadmin@uweflix.com',
            'password' => 'adminpass',
            'role_id' => Role::firstWhere('code', Role::ADMIN_CODE),
            'wants_manager' => false,
        ]);

        // create cinema manager user
        User::factory(1)->create([
            'first_name' => 'cinemaManager',
            'username' => 'cinemaManager',
            'email' => 'cm-manager@uweflix.com',
            'password' => 'cm_managerpass',
        ...
        User::factory(1)->create([
            'first_name' => 'customer',
            'username' => 'customer',
            'email' => 'customer@uweflix.com',
            'password' => 'customerpass',
            'role_id' => Role::firstWhere('code', Role::CUSTOMER_CODE),
            'wants_manager' => false,
        ]);

        // create club reprentative
        User::factory(1)->create([
            'first_name' => 'clubRep',
            'username' => 'clubRep',
            'email' => 'clubRep@uweflix.com',
            'password' => 'clubpass',
            'role_id' => Role::firstWhere('code', Role::CLUBREP_CODE),
            'wants_manager' => false,
        ]);
