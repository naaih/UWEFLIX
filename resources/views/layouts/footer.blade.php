                    ...
                    <div class="d-flex">
                        <div class="links">
                            <ul class="list-inline">
                                <li class="list-inline-item"><a href="{{ route('uweflix-privacy') }}">Privacy & Cookies</a></li>
                                <li class="list-inline-item"><a href="{{ route('term-con') }}">Terms & Conditions</a></li>
                            </ul>
                        </div>

                        <div class="copyright ml-auto">&copy; 2024 UWEFlix</div>
