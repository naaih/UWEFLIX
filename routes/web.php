...
Route::get('/privacy', function () {
    return view('pages.uweflix-privacy');
})->name('uweflix-privacy');

Route::get('/toc', function () {
    return view('pages.term-con');
})->name('term-con');
...
// Print Ticket
Route::get('reservations/{reservation}/print-ticket', [ReservationController::class, 'printTicket'])
    ->name('reservations.printTicket');